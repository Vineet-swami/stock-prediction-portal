...
class StockPredictionAPIView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            plt.title(f'100 Day Moving Average - {ticker} Stock Price')
            plt.xlabel('Days')
            plt.ylabel('Closing price')
            plt.legend()
            ...
            plt.title(f'200 Day Moving Average - {ticker} Stock Price')
            plt.xlabel('Days')
            plt.ylabel('Closing price')
            plt.legend()
            ...
            #Revert the scaled prices back to original form
            ...
            plt.ylabel('Price')
            plt.legend()
            plot_img_path = f'{ticker}_predicted_price.png'
            plot_img = save_plot(plot_img_path)     
